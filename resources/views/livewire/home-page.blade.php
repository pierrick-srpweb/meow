                ...
                <div>
                    ...
                    <ul class="list-none pl-0 my-5 space-y-2.5">
                        <li class="relative pl-7 font-nunito font-bold text-heading">
                            <img src="{{ asset('build/images/svgs/about1.svg') }}" alt="" aria-hidden="true" class="absolute left-0 top-[5px]">
    ...
    <div class="relative text-center pt-[100px] pb-[45px] max-lg:pt-[60px] max-lg:pb-0">
        <div class="container-bs">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {{-- Card 1: Faire un don --}}
                <a href="{{ $site_dons }}" target="_blank" rel="noreferrer noopener" data-pan="don" aria-label="Faire un don (ouvre dans un nouvel onglet)">
                ...
                <a href="{{ $facebook }}" target="_blank" rel="noreferrer noopener" data-pan="facebook" aria-label="Relayer nos actions sur Facebook (ouvre dans un nouvel onglet)">
                    <div class="creativity-card mb-[35px] px-5 py-4 max-lg:mb-5 max-lg:px-5 max-lg:py-0">
                        <div class="w-[100px] h-[100px] max-lg:w-[70px] max-lg:h-[70px] rounded-full border-2 border-dashed border-pink-light flex items-center justify-center mx-auto mb-6 max-lg:mb-3 text-pink-light">
